...
- ไอคอนมุมฉากที่มุมขวาจอเกมสลับปกติ / ขยาย / เต็มจอมือถือ โหมดเต็มจอซ่อนตัวเครื่องและแถบระบบ ใช้ปุ่มโปร่งใสเหนือภาพ; เต็มจอแนวตั้งเติมภาพทั้งจอ (ภาพยืดตามสัดส่วนมือถือ); เปิด FULL SCREEN คงสัดส่วน 3:2 ใน settings หากต้องการภาพไม่ยืดและยอมรับขอบดำ
