...
- MENU → RESTART GAME: ยืนยันเพื่อเริ่มเกมใหม่ โดยเก็บเซฟในเกมและ Save Slots; แทนที่ auto-save ด้วยจุดเริ่มใหม่
- ADJUST SCREEN บันทึกขนาดและตำแหน่งภาพแนวนอนเมื่อปล่อยนิ้วและเมื่อออกจากแอป คืนค่าเป็นสัดส่วนเมื่อเปิดใหม่; RESET SCREEN POSITION ล้างค่าที่จำไว้ และปุ่มเลือกระดับขนาดจะกลับไปใช้ขนาดสำเร็จรูป
- GRAPHICS & AUDIO → ULTIMATE GRAPHIC: Scale2x เกลี่ยขอบพิกเซลก่อนขยายแบบ bilinear; วาดตามจังหวะหน้าจอ โดยไม่เปลี่ยนความเร็วหรือเฟรมเรตต้นฉบับ ใช้การประมวลผลเพิ่มจาก Pixel
...
- แนวตั้งมี 2 ระดับ (ปกติ / ขยาย); แนวนอนมี 8 ระดับไล่ต่อเนื่องโดยไม่แสดงแถบควบคุมด้านบน และระดับ 8 ซ่อน status/navigation bar ของ Android ส่วนปรับอิสระอยู่ที่ MENU → ADJUST SCREEN: ลากมุมกรอบเพื่อขยาย และลากกลางภาพเพื่อเลื่อนตำแหน่งเต็มพื้นที่ โดยภาพรักษาสัดส่วน 3:2
