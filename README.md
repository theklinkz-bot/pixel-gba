...
- แนวตั้งมี 2 ระดับ (ปกติ / ขยาย); แนวนอนมี 8 ระดับไล่ต่อเนื่อง โดยระดับ 8 เป็น fullscreen ซ่อนแถบแอปและ status bar ส่วนปรับอิสระอยู่ที่ MENU → ADJUST SCREEN: ลากมุมกรอบเพื่อขยาย และลากกลางภาพเพื่อเลื่อนตำแหน่งเต็มพื้นที่รวมแถบด้านบน โดยภาพรักษาสัดส่วน 3:2
